...
const Header = () => {
  ...
  return (
    <div>
      <div className='flex flex-col h-fit self-center z-[5] my-[20px] mx-[40px] p-2 bg-[#EDFAE4] backdrop-blur-[2px] border-[2px] border-[#19192C] bg-opacity-60 bg-blend-normal rounded-2xl transition-[0.25s] duration-[ease-in-out]'>
        <div className='flex h-full w-full justify-between items-center self-center'>
          ...
          <div onClick={UpdateMenu} className='w-[45px] h-[45px] z-[5] justify-around flex flex-col cursor-pointer'>
            <div className={`${burger_class} w-[45px] h-2 bg-[#19192C] rotate-0 transition-[0.25s] duration-[ease-in-out] rounded-lg `}></div>
            <div className={`${burger_class} w-[45px] h-2 bg-[#19192C] rotate-0 transition-[0.25s] duration-[ease-in-out] rounded-lg `}></div>
            <div className={`${burger_class} w-[45px] h-2 bg-[#19192C] rotate-0 transition-[0.25s] duration-[ease-in-out] rounded-lg `}></div>
          </div>
        </div>
